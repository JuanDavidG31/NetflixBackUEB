 ...
 * <p>
 * Este controlador proporciona endpoints para crear, obtener y eliminar películas.
 * </p>
 */
@RestController
...
public class MovieController {
     ...
     */
	@PostMapping("/create")
	public ResponseEntity<String> create(@RequestParam String url, @RequestParam String nombre,
