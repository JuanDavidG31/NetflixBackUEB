 ...
 * <p>
 * Incluye métodos para enviar solicitudes HTTP GET y formatear respuestas JSON de manera legible.
 * </p>
 */
...
public class ExternalHTTPRequestHandler {
     ...
     * <p>
     * Configurado con una conexión de tiempo de espera de 10 segundos y la versión HTTP/2.
     * </p>
     */
	private static final HttpClient HTTP_CLIENT = HttpClient.newBuilder().version(HttpClient.Version.HTTP_2)
			.connectTimeout(Duration.ofSeconds(10)).build();
	/**
     * Realiza una solicitud HTTP GET a una URL y devuelve la respuesta JSON formateada de manera legible.
     * 
