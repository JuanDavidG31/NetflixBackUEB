 ...
 *
 * <p>Esta clase está mapeada a la tabla "movie" en la base de datos y contiene información como el
 * identificador único, la URL del recurso, el nombre y el género de la película.
 */
@Entity
@Table(name = "movie")
public class Movie {
