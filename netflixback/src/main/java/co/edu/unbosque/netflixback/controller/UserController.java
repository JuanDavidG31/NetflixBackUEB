 ...
 *
 * <p>Este controlador proporciona endpoints para crear, actualizar, obtener y eliminar usuarios.
 */
@RestController
@RequestMapping("/user")
@CrossOrigin(origins = {"*"})
public class UserController {
  ...
  public ResponseEntity<String> eliminarPorUser(@PathVariable String user) {
    ...
    return estado == 0
        ? new ResponseEntity<>("Usuario eliminado con éxito", HttpStatus.OK)
